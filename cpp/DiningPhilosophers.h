#ifndef DINNINGPHILOSOPHERS_H
#define DINNINGPHILOSOPHERS_H
...
public:
	Philosopher(Chopstick &l, Chopstick &r, ZThread::CountedPtr<Display> &disp, int ident, int ponder)
